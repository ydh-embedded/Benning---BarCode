...
KUNDE: Napoli
Gerätenummern: Napoli - 0001 bis Napoli - 0500
"""
...
class PrintServiceBarcodeGenerator:
    ...
    def generate_barcode_image(self, number):
        ...
        writer = ImageWriter()
        writer.set_options({
            'module_width': 0.30,     # OPTIMIERT: Etwas schmaler wegen "Napoli - "
            'module_height': 12,      # OPTIMIERT: Höherer Barcode
            'quiet_zone': 3,          # OPTIMIERT: Mehr Rand
            'font_size': 8,           # OPTIMIERT: Größere Schrift (8 statt 6)
            'text_distance': 3,       # OPTIMIERT: Mehr Abstand
            'write_text': True,
            'dpi': 300,               # OPTIMIERT: Höhere Auflösung
        })
...
def main():
    ...
    print("  • Inhalt: 'Napoli - 0001' bis 'Napoli - 0500'")
